...
const EditForm = ({ isOpen, onClose, onAddCustomer, onChangeInput, showDeleteModal, errorMessage, isInvalid }) => {
  return (
    <Box maxHeight='708px'>
    <Modal  isOpen={isOpen} onClose={onClose} modalHeading='Bulk assign' employeeName='Finance'>
      <Form   onSubmit={onAddCustomer} isInvalid={isInvalid}>
        <ModalBody paddingY={0}>
          ...
          <Button onClick={showDeleteModal}  title='Clear all selections' size='large' color='default' />
