...
const EditCustomer = ({ isOpen, onClose, onEditCustomer, onChangeInput, errorMessage, isInvalid }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} modalHeading='Edit customer'>
      <Form onSubmit={onEditCustomer} isInvalid={isInvalid}>
        <ModalBody paddingY={0}>
          ...
          <Input textArea errorMessage={errorMessage.description} onChange={onChangeInput} label='General description' name='description' placeholder='Enter description' marginX={0} />
          <Input textArea errorMessage={errorMessage.code} onChange={onChangeInput} label='Codes' name='code' placeholder='Enter codes' marginX={0} />
        </ModalBody>
